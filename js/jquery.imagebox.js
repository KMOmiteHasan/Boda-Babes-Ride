/**
* æ‰©å±•jqueryæ’ä»¶
* options: {objClicked: ç‚¹å‡»objClickedæµè§ˆå›¾ç‰‡ required, fileName: å›¾ç‰‡æ ‡é¢˜å…ƒç´  options, rotateDirection: å›¾ç‰‡æ—‹è½¬æ–¹å‘, options}
*/
(function($){
  $.fn.imageBox = function(options){
    var options = $.extend({
      objClicked: '.img',      // ç‚¹å‡»çš„å…ƒç´ 
      rotateDirection: 'right' // å›¾ç‰‡æ—‹è½¬æ–¹å‘ï¼Œ é»˜è®¤æ˜¯right => é¡ºæ—¶é’ˆ
    }, options);   
